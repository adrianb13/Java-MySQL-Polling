...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
		...
		if(userRepository.existsByEmail(signUpRequest.getEmail())) {
			return new ResponseEntity(new ApiResponse(false, "Email Address alread in use!"), HttpStatus.BAD_REQUEST);
		}
		...
		return ResponseEntity.created(location).body(new ApiResponse(true, "User registration successful"));
	}
}
